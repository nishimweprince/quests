  ...
  return (
    <footer className="footer">
      <div className="footer-grid">
        ...
        <nav className="footer-links footer-links--secondary" aria-label="Secondary navigation"><a href="https://www.linkedin.com/company/agaciro-development-fund">LinkedIn</a><Link href="/about/board">Board</Link><Link href="/about/team">Team</Link><Link href="/terms-of-use">Terms of Use</Link><Link href="/privacy-policy">Privacy Policy</Link></nav>
