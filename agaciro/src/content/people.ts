...
const person = (
  ...
  image:
    slug === "ulrich-kayinamura"
      ? "/media/portrait-ulrich.jpg"
      : slug === "scott-t-ford"
        ? "/media/portrait-scott.jpg"
        : /^(Mrs\.|Lilian|Valentine|Elise|Sabine|Sandrine)/.test(name)
          ? "/media/portrait-female.jpg"
          : kind === "board"
            ? "/media/portrait-scott.jpg"
            : "/media/portrait-ulrich.jpg",
});
...
export const people: Person[] = [
  ...
  person(
    "Bienfait Banaga",
    "Ag. Chief Finance and Administrative Officer",
    "team",
    "bienfait-banaga",
  ),
