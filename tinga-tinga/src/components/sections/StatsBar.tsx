...
export function StatsBar() {
  return (
    <section id="stats" className="relative">
      ...
      <div className="relative bg-[linear-gradient(90deg,transparent,rgba(212,162,83,0.04),transparent)]">
        <div className="mx-auto grid w-[min(1180px,92vw)] gap-px sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((item, index) => (
            ...
            >
              ...
              <p className="font-mono text-2xl font-semibold text-gold-gradient md:text-3xl">
